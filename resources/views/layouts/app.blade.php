...
<div class="shell">
    ...
    <aside class="sidebar" :class="sidebarOpen ? 'open' : ''">
        <div class="sidebar-header">
            <div class="brand-mark">{{ strtoupper(config('hotel.name', 'Mon Hotel')) }}</div>
            <div class="brand-sub">Luxecontrol Admin<br>Hotel Management</div>
        </div>

        <nav class="nav">
            @foreach($mainMenu as $item)
                <a href="{{ route($item['route']) }}" class="nav-link {{ request()->routeIs(...$item['patterns']) ? 'active' : '' }}">
                    <span class="nav-icon">{{ $item['icon'] }}</span>
                    <span>{{ $item['label'] }}</span>
                </a>
            @endforeach

            @if(count($supportMenu))
        ...
        @if($isAdminLike || $isReceptionist)
            <div class="sidebar-cta">
                <a class="btn-primary" href="{{ route('reservations.create') }}">Nouvelle reservation</a>
            </div>
        @endif
        ...
        <div class="sidebar-footer">
            <div class="user-card">
                ...
                <div>
                    ...
                    <div class="user-role">{{ ucfirst($roleName) }}</div>
                </div>
            </div>
        </div>
    </aside>
    ...
    <div class="main">
        <header class="topbar">
            <div class="topbar-left">
                ...
                <div>
                    ...
                    <div class="page-subtitle">@yield('page_subtitle', now()->isoFormat('dddd D MMMM YYYY'))</div>
                </div>
            </div>
        ...
        <footer class="app-footer">
            <div>© {{ date('Y') }} {{ config('hotel.name', 'Mon Hotel') }} Hotel Management System. Tous droits reserves.</div>
            <div class="footer-badges">
                <div class="footer-chip">Serveur central: {{ strtoupper(config('hotel.city', 'Abidjan')) }}</div>
