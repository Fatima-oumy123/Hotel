...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Reservation'); ?> - <?php echo e(config('hotel.name', 'Mon Hotel')); ?></title>
...
<body>
    <nav class="guest-nav">
        <div class="container guest-nav-inner">
            <a href="<?php echo e(route('home')); ?>" class="brand"><?php echo e(strtoupper(config('hotel.name', 'Mon Hotel'))); ?></a>
            <div class="nav-links">
                <a href="<?php echo e(route('home')); ?>">Accueil</a>
                <a href="<?php echo e(route('guest.step1')); ?>">Reservation</a>
                <a href="<?php echo e(route('guest.cancel')); ?>">Gerer ma reservation</a>
                <a href="<?php echo e(route('login')); ?>">Connexion staff</a>
            </div>
            <div class="nav-actions">
                <a href="<?php echo e(route('visitor.portal')); ?>" class="btn-secondary">Visiter</a>
                <a href="<?php echo e(route('guest.step1')); ?>" class="btn-primary">Reserver</a>
            </div>
        </div>
    </nav>
    ...
    <section class="hero-shell">
        <div class="container hero-content">
            <div class="hero-grid">
                <div>
                    <div class="eyebrow"><?php echo $__env->yieldContent('hero_eyebrow', 'Rufisque · Reservation en ligne'); ?></div>
                    <h1 class="hero-title"><?php echo $__env->yieldContent('hero_title', 'Votre sejour familial et luxueux commence ici.'); ?></h1>
                    <p class="hero-copy"><?php echo $__env->yieldContent('hero_copy', 'Consultez les disponibilites, choisissez votre chambre et confirmez en toute serenite : confort, prix abordables, zone calme et proche du Lac Rose.'); ?></p>
                </div>
                <div class="hero-card">
                    <h3><?php echo $__env->yieldContent('card_title', 'Parcours simplifie'); ?></h3>
                    <p><?php echo $__env->yieldContent('card_copy', 'Des etapes claires, un total transparent et une reservation simple, depuis ordinateur ou smartphone.'); ?></p>
                    <div class="hero-mini">
                        <?php echo $__env->yieldContent('hero_stats'); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main class="content-wrap">
        ...
        <div class="container footer-note">
            <?php echo e(config('hotel.name', 'Keur Ndiaye Lo')); ?> · Rufisque · zone calme · proche du Lac Rose · confort · prix abordables
        </div>
    </main>
    <?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html>
<?php /**PATH C:\Users\binet\Desktop\xammp\htdocs\Mon_hotel\resources\views/layouts/guest.blade.php ENDPATH**/ ?>