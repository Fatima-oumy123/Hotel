...
<head>
    ...
    <title>Connexion - <?php echo e(config('hotel.name', 'Mon Hotel')); ?></title>
    ...
    <div class="shell">
        ...
        <section class="panel">
            ...
            <?php if(session('success')): ?>
                <div class="notice ok"><?php echo e(session('success')); ?></div>
            <?php endif; ?>
            <?php if($errors->any()): ?>
                <div class="notice err"><?php echo e($errors->first()); ?></div>
            <?php endif; ?>
            ...
            <form action="<?php echo e(route('login')); ?>" method="POST">
                ...
                <div class="field">
                    ...
                    <input class="input" type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="admin@hotel.com" required autofocus>
                </div>
                ...
                <div class="row">
                    <a class="link" href="<?php echo e(route('password.request')); ?>">Mot de passe oublie ?</a>
                    <a class="link" href="<?php echo e(route('visitor.portal')); ?>">Entrer comme visiteur</a>
                </div>
            ...
            <div class="back">
                <a href="<?php echo e(route('home')); ?>">Retour a l accueil</a>
                <a href="<?php echo e(route('guest.step1')); ?>">Reservation publique</a>
            </div>
...
<?php /**PATH C:\Users\binet\Desktop\xammp\htdocs\Mon_hotel\resources\views/auth/login.blade.php ENDPATH**/ ?>