...
<head>
    ...
    <title>Mode visiteur - <?php echo e(config('hotel.name', 'Mon Hotel')); ?></title>
...
<body>
    <div class="shell">
        <aside class="sidebar">
            <div class="brand">
                <h1><?php echo e(strtoupper(config('hotel.name', 'Mon Hotel'))); ?></h1>
                <p>Mode visiteur</p>
            </div>
            <nav class="nav">
                <a href="<?php echo e(route('home')); ?>">⌂ <span>Accueil</span></a>
                <a href="#chambres" class="active">▤ <span>Chambres</span></a>
                <a href="<?php echo e(route('guest.step1')); ?>">◷ <span>Reserver</span></a>
            </nav>
            <div class="cta">
                <a href="<?php echo e(route('guest.step1')); ?>">Reserver maintenant</a>
            </div>
        </aside>
        ...
        <main class="main">
            <div class="topbar">
                <div>
                    ...
                    <p>Decouvrez <strong><?php echo e(config('hotel.name', 'Keur Ndiaye Lo')); ?></strong> a Rufisque : confort, tarifs accessibles, zone calme et proche du Lac Rose.</p>
                </div>
                <div class="actions">
                    <a href="<?php echo e(route('home')); ?>" class="btn-outline">Retour accueil</a>
                    <a href="<?php echo e(route('login')); ?>" class="btn-outline">Connexion staff</a>
                ...
                <div class="grid">
                    <div class="stats">
                        <div class="card kpi">
                            ...
                            <div class="value"><?php echo e($featuredRooms->count()); ?></div>
                            ...
                            <div class="panel-body">
                                <div class="room-grid">
                                    <?php $__empty_1 = true; $__currentLoopData = $featuredRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        ?>
                                        <article class="room">
                                            <div class="photo" style="background-image:url('<?php echo e($images[$index % count($images)]); ?>')"></div>
                                            <div class="room-body">
                                                <h4><?php echo e($room->roomType->name ?? 'Chambre'); ?></h4>
                                                <p>Chambre <?php echo e($room->number); ?> · Un cocon confortable, ideal pour se reposer en toute tranquillite.</p>
                                                <div class="price">A partir de <?php echo e(number_format((float) ($room->base_price ?? 0), 0, ',', ' ')); ?> <?php echo e(config('hotel.currency')); ?></div>
                                            </div>
                                        </article>
...
<?php /**PATH C:\Users\binet\Desktop\xammp\htdocs\Mon_hotel\resources\views/visitor/portal.blade.php ENDPATH**/ ?>