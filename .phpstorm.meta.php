...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\binet\Desktop\xammp\htdocs\Mon_hotel\public\storage' => 'string',
            'hotel.name' => 'string',
            'hotel.tax_rate' => 'integer',
            'hotel.stay_tax_per_night' => 'integer',
            'hotel.currency' => 'string',
            'hotel.currency_symbol' => 'string',
            'hotel.timezone' => 'string',
            'hotel.check_in_time' => 'string',
            'hotel.check_out_time' => 'string',
            'hotel.max_advance_booking' => 'integer',
            'hotel.cancellation_hours' => 'integer',
            'hotel.lang_default' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\binet\\Desktop\\xammp\\htdocs\\Mon_hotel\\public\\storage','hotel.name',
'hotel.tax_rate','hotel.stay_tax_per_night','hotel.currency','hotel.currency_symbol','hotel.timezone',
'hotel.check_in_time','hotel.check_out_time','hotel.max_advance_booking','hotel.cancellation_hours','hotel.lang_default',
'hotel.address','hotel.phone','hotel.email','hotel.logo','logging.default',
...
'signed','throttle','verified','LogActivity',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','login','logout',
'password.request','password.email','password.reset','password.update','guest.step1',
'guest.search','guest.step2','guest.confirm','guest.payment','guest.payment.process',
'guest.success','guest.cancel','guest.cancel.process','dashboard','rooms.index',
'rooms.create','rooms.store','rooms.show','rooms.edit','rooms.update',
'rooms.destroy','rooms.update-status','room-types.index','room-types.create','room-types.store',
'room-types.show','room-types.edit','room-types.update','room-types.destroy','reservations.index',
'reservations.create','reservations.store','reservations.show','reservations.edit','reservations.update',
'reservations.destroy','reservations.checkin','reservations.checkout','reservations.calendar','payments.index',
'payments.create','payments.store','payments.show','payments.refund','stripe.intent',
'invoices.index','invoices.show','invoices.generate','invoices.download','invoices.cancel',
'maintenance.index','maintenance.create','maintenance.store','maintenance.show','maintenance.edit',
'maintenance.update','maintenance.destroy','employees.index','employees.create','employees.store',
'employees.show','employees.edit','employees.update','employees.destroy','restaurant.index',
'restaurant.create','restaurant.store','restaurant.cancel','restaurant.monthly','expenses.index',
'expenses.create','expenses.store','expenses.show','expenses.edit','expenses.update',
'expenses.destroy','reports.index','reports.export','users.index','users.create',
'users.store','users.edit','users.update','users.destroy','users.toggle-status',
'audit-logs.index','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'Maintenance.create','Maintenance.edit','Maintenance.index','Maintenance.show','auditlogs.index',
'auth.Forgot-password','auth.Login','dashboard.index','emails.reservation-confirmation','employee.create',
'employee.edit','employee.index','employee.show','expenses.create','expenses.edit',
'expenses.index','expenses.show','guest.cancel','guest.payment','guest.results',
'guest.step1','guest.step2','guest.success','invoices.index','invoices.show',
'layouts.app','partials.Page-header','payments.create','payments.index','payments.show',
'pdf.invoice','pdf.report','reports.index','reservations.calendar','reservations.create',
'reservations.index','reservations.show','restaurant.create','restaurant.index','rooms.create',
'rooms.edit','rooms.index','rooms.show','users.create','users.edit',
...
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.Users.binet.Desktop.xammp.htdocs.Mon_hotel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_URL','APP_LOCALE','APP_ENV','APP_DEBUG',
'DB_CONNECTION','DB_HOST','DB_PORT','DB_DATABASE','DB_USERNAME',
'DB_PASSWORD','MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME',
'MAIL_PASSWORD','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','STRIPE_KEY','STRIPE_SECRET',
'QUEUE_CONNECTION',);
